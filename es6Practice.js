...
3. arrow function 
    ...
    3.  b: with two parameters, will add two to each number and then 
           multiply the result.
    3.  c: three parameters, will multiply all thre parameters
    3.  d: with two parameters but it will be a multiline arrow function. will
           add two to each number and then multiply the result.
